...
class FoodIngredientsMapProducts {
  ...
  constructor(id, title, upc) {
    FoodIngredientsMapProducts.initialize(this, id, title, upc)
  }
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new FoodIngredientsMapProducts()
      ...
      if (data.hasOwnProperty('upc')) {
        obj['upc'] = ApiClient_1.default.convertToType(data['upc'], 'String')
      }
    }
    return obj
  }
 ...
 * @member {Number} id
 */
FoodIngredientsMapProducts.prototype['id'] = undefined
/**
 * @member {String} title
 */
FoodIngredientsMapProducts.prototype['title'] = undefined
/**
 * @member {String} upc
 */
FoodIngredientsMapProducts.prototype['upc'] = undefined
exports.default = FoodIngredientsMapProducts
