...
class InlineObject {
  ...
  constructor(title, upc, pluCode) {
    InlineObject.initialize(this, title, upc, pluCode)
  }
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('plu_code')) {
        obj['plu_code'] = ApiClient_1.default.convertToType(
          data['plu_code'],
          'String'
        )
      }
 ...
 * @member {String} upc
 */
InlineObject.prototype['upc'] = undefined
/**
 * @member {String} plu_code
 */
InlineObject.prototype['plu_code'] = undefined
