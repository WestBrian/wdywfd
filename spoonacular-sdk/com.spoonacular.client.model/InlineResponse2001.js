...
const RecipesFindByIngredientsMissedIngredients_1 = __importDefault(
  require('./RecipesFindByIngredientsMissedIngredients')
)
/**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('missedIngredientCount')) {
        obj['missedIngredientCount'] = ApiClient_1.default.convertToType(
          data['missedIngredientCount'],
          'Number'
        )
      }
      if (data.hasOwnProperty('missedIngredients')) {
        obj['missedIngredients'] = ApiClient_1.default.convertToType(
      ...
      if (data.hasOwnProperty('unusedIngredients')) {
        obj['unusedIngredients'] = ApiClient_1.default.convertToType(
          data['unusedIngredients'],
          [Object]
        )
      }
      if (data.hasOwnProperty('usedIngredientCount')) {
        obj['usedIngredientCount'] = ApiClient_1.default.convertToType(
          data['usedIngredientCount'],
          'Number'
        )
      }
      if (data.hasOwnProperty('usedIngredients')) {
        obj['usedIngredients'] = ApiClient_1.default.convertToType(
          data['usedIngredients'],
          [RecipesFindByIngredientsMissedIngredients_1.default]
        )
      }
      if (data.hasOwnProperty('')) {
        obj[''] = ApiClient_1.default.convertToType(data[''], 'String')
      }
    }
    return obj
  }
