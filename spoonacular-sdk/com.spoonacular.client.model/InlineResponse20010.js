...
const InlineResponse20010Ingredients_1 = __importDefault(
  require('./InlineResponse20010Ingredients')
)
/**
...
class InlineResponse20010 {
   ...
   */
  constructor(ingredients, totalCost, totalCostPerServing) {
    InlineResponse20010.initialize(
      this,
      ingredients,
      totalCost,
      totalCostPerServing
   ...
   */
  static initialize(obj, ingredients, totalCost, totalCostPerServing) {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('totalCost')) {
        obj['totalCost'] = ApiClient_1.default.convertToType(
          data['totalCost'],
          'Number'
        )
      }
      if (data.hasOwnProperty('totalCostPerServing')) {
        obj['totalCostPerServing'] = ApiClient_1.default.convertToType(
          data['totalCostPerServing'],
          'Number'
        )
      }
    }
