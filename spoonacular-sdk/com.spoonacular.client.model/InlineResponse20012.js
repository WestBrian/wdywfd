...
class InlineResponse20012 {
  ...
  constructor(calories, carbs, fat, protein, bad, good) {
    InlineResponse20012.initialize(
      this,
      calories,
      carbs,
      fat,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('bad')) {
        obj['bad'] = ApiClient_1.default.convertToType(data['bad'], [Object])
      }
      if (data.hasOwnProperty('good')) {
        obj['good'] = ApiClient_1.default.convertToType(data['good'], [Object])
      }
    }
    return obj
  }
...
exports.default = InlineResponse20012
