...
class InlineResponse20017 {
  ...
  constructor(cuisine, cuisines, confidence) {
    InlineResponse20017.initialize(this, cuisine, cuisines, confidence)
  }
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cuisine')) {
        obj['cuisine'] = ApiClient_1.default.convertToType(
          data['cuisine'],
          'String'
        )
      }
      ...
      if (data.hasOwnProperty('confidence')) {
        obj['confidence'] = ApiClient_1.default.convertToType(
          data['confidence'],
          'Number'
        )
      }
 ...
 */
InlineResponse20017.prototype['cuisine'] = undefined
/**
 * @member {Array.<String>} cuisines
 */
InlineResponse20017.prototype['cuisines'] = undefined
/**
 * @member {Number} confidence
 */
InlineResponse20017.prototype['confidence'] = undefined
exports.default = InlineResponse20017
