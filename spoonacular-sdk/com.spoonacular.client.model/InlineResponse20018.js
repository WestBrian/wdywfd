...
const InlineResponse20018Dishes_1 = __importDefault(
  require('./InlineResponse20018Dishes')
)
const InlineResponse20018Ingredients_1 = __importDefault(
  require('./InlineResponse20018Ingredients')
)
/**
...
class InlineResponse20018 {
  ...
  constructor(dishes, ingredients, cuisines, modifiers) {
    InlineResponse20018.initialize(
      this,
      dishes,
      ingredients,
      cuisines,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('dishes')) {
        obj['dishes'] = ApiClient_1.default.convertToType(data['dishes'], [
          InlineResponse20018Dishes_1.default,
        ])
      }
      ...
      if (data.hasOwnProperty('modifiers')) {
        obj['modifiers'] = ApiClient_1.default.convertToType(
          data['modifiers'],
          ['String']
        )
      }
