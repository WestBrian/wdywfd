...
const RecipesParseIngredientsNutrition_1 = __importDefault(
  require('./RecipesParseIngredientsNutrition')
)
/**
...
class InlineResponse20020 {
  ...
  constructor(
    ...
    InlineResponse20020.initialize(
      this,
      id,
      original,
      originalName,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('meta')) {
        obj['meta'] = ApiClient_1.default.convertToType(data['meta'], [
          'String',
        ])
      }
      if (data.hasOwnProperty('nutrition')) {
        obj['nutrition'] =
          RecipesParseIngredientsNutrition_1.default.constructFromObject(
            data['nutrition']
          )
      }
    }
