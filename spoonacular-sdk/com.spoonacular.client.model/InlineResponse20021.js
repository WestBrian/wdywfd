...
const InlineResponse20021Calories_1 = __importDefault(
  require('./InlineResponse20021Calories')
)
/**
...
class InlineResponse20021 {
  ...
  constructor(calories, carbs, fat, protein, recipesUsed) {
    InlineResponse20021.initialize(
      this,
      calories,
      carbs,
      fat,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('calories')) {
        obj['calories'] =
          InlineResponse20021Calories_1.default.constructFromObject(
            data['calories']
          )
      }
      ...
      if (data.hasOwnProperty('fat')) {
        obj['fat'] = InlineResponse20021Calories_1.default.constructFromObject(
          data['fat']
        )
      }
      ...
      if (data.hasOwnProperty('recipesUsed')) {
        obj['recipesUsed'] = ApiClient_1.default.convertToType(
          data['recipesUsed'],
          'Number'
        )
      }
