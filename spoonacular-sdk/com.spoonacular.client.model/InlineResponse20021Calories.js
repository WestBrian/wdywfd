...
const InlineResponse20021CaloriesConfidenceRange95Percent_1 = __importDefault(
  require('./InlineResponse20021CaloriesConfidenceRange95Percent')
)
/**
...
class InlineResponse20021Calories {
  ...
  constructor(confidenceRange95Percent, standardDeviation, unit, value) {
    InlineResponse20021Calories.initialize(
      this,
    ...
    if (data) {
      ...
      if (data.hasOwnProperty('confidenceRange95Percent')) {
        obj['confidenceRange95Percent'] =
          InlineResponse20021CaloriesConfidenceRange95Percent_1.default.constructFromObject(
