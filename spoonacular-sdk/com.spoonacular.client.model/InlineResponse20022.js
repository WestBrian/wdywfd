...
const InlineResponse20022Nutrition_1 = __importDefault(
  require('./InlineResponse20022Nutrition')
)
const RecipesParseIngredientsEstimatedCost_1 = __importDefault(
  require('./RecipesParseIngredientsEstimatedCost')
)
/**
...
class InlineResponse20022 {
  ...
  constructor(
    ...
    InlineResponse20022.initialize(
      this,
      id,
      original,
      originalName,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('original')) {
        obj['original'] = ApiClient_1.default.convertToType(
          data['original'],
          'String'
        )
      }
      if (data.hasOwnProperty('originalName')) {
        obj['originalName'] = ApiClient_1.default.convertToType(
          data['originalName'],
          'String'
        )
      }
      ...
      if (data.hasOwnProperty('nameClean')) {
        obj['nameClean'] = ApiClient_1.default.convertToType(
          data['nameClean'],
          'String'
        )
      }
      ...
      if (data.hasOwnProperty('unitShort')) {
        obj['unitShort'] = ApiClient_1.default.convertToType(
          data['unitShort'],
          'String'
        )
      }
      if (data.hasOwnProperty('unitLong')) {
        obj['unitLong'] = ApiClient_1.default.convertToType(
          data['unitLong'],
          'String'
        )
      }
      if (data.hasOwnProperty('possibleUnits')) {
        obj['possibleUnits'] = ApiClient_1.default.convertToType(
          data['possibleUnits'],
          ['String']
        )
      }
      if (data.hasOwnProperty('estimatedCost')) {
        obj['estimatedCost'] =
          RecipesParseIngredientsEstimatedCost_1.default.constructFromObject(
            data['estimatedCost']
          )
      }
      if (data.hasOwnProperty('consistency')) {
        obj['consistency'] = ApiClient_1.default.convertToType(
          data['consistency'],
          'String'
        )
      }
      if (data.hasOwnProperty('shoppingListUnits')) {
        obj['shoppingListUnits'] = ApiClient_1.default.convertToType(
          data['shoppingListUnits'],
          ['String']
        )
      }
      ...
      if (data.hasOwnProperty('meta')) {
        obj['meta'] = ApiClient_1.default.convertToType(data['meta'], [Object])
      }
      if (data.hasOwnProperty('nutrition')) {
        obj['nutrition'] =
          InlineResponse20022Nutrition_1.default.constructFromObject(
            data['nutrition']
          )
      }
      if (data.hasOwnProperty('categoryPath')) {
        obj['categoryPath'] = ApiClient_1.default.convertToType(
          data['categoryPath'],
          ['String']
        )
      }
