...
class InlineResponse20023Ingredients {
  ...
  constructor(id, original, glycemicIndex, glycemicLoad) {
    InlineResponse20023Ingredients.initialize(
      this,
      id,
      original,
      glycemicIndex,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('glycemicIndex')) {
        obj['glycemicIndex'] = ApiClient_1.default.convertToType(
          data['glycemicIndex'],
          'Number'
        )
      }
      if (data.hasOwnProperty('glycemicLoad')) {
        obj['glycemicLoad'] = ApiClient_1.default.convertToType(
          data['glycemicLoad'],
          'Number'
        )
      }
...
exports.default = InlineResponse20023Ingredients
