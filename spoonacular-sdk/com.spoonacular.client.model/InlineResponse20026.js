...
class InlineResponse20026 {
  ...
  constructor(ingredient, substitutes, message) {
    InlineResponse20026.initialize(this, ingredient, substitutes, message)
  }
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ingredient')) {
        obj['ingredient'] = ApiClient_1.default.convertToType(
          data['ingredient'],
          'String'
        )
      }
      if (data.hasOwnProperty('substitutes')) {
        obj['substitutes'] = ApiClient_1.default.convertToType(
          data['substitutes'],
          ['String']
        )
      }
      if (data.hasOwnProperty('message')) {
        obj['message'] = ApiClient_1.default.convertToType(
          data['message'],
          'String'
        )
      }
 ...
 */
InlineResponse20026.prototype['ingredient'] = undefined
/**
 * @member {Array.<String>} substitutes
 */
InlineResponse20026.prototype['substitutes'] = undefined
/**
 * @member {String} message
 */
InlineResponse20026.prototype['message'] = undefined
exports.default = InlineResponse20026
