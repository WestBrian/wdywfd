...
const InlineResponse2007_1 = __importDefault(require('./InlineResponse2007'))
/**
...
class InlineResponse20027 {
  ...
  constructor(products, totalProducts, type, offset, _number) {
    InlineResponse20027.initialize(
      this,
      products,
      totalProducts,
      type,
    ...
    if (data) {
      ...
      if (data.hasOwnProperty('products')) {
        obj['products'] = ApiClient_1.default.convertToType(data['products'], [
          InlineResponse2007_1.default,
        ])
      }
      if (data.hasOwnProperty('totalProducts')) {
        obj['totalProducts'] = ApiClient_1.default.convertToType(
          data['totalProducts'],
          'Number'
        )
      }
