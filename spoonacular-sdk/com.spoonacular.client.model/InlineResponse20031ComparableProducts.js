...
const InlineResponse20031ComparableProductsProtein_1 = __importDefault(
  require('./InlineResponse20031ComparableProductsProtein')
)
/**
...
class InlineResponse20031ComparableProducts {
  ...
  constructor(calories, likes, price, protein, spoonacularScore, sugar) {
    InlineResponse20031ComparableProducts.initialize(
      this,
      calories,
      likes,
      price,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('calories')) {
        obj['calories'] = ApiClient_1.default.convertToType(data['calories'], [
          Object,
        ])
      }
      if (data.hasOwnProperty('likes')) {
        obj['likes'] = ApiClient_1.default.convertToType(data['likes'], [
          Object,
        ])
      }
      if (data.hasOwnProperty('price')) {
        obj['price'] = ApiClient_1.default.convertToType(data['price'], [
          Object,
        ])
      }
      if (data.hasOwnProperty('protein')) {
        obj['protein'] = ApiClient_1.default.convertToType(data['protein'], [
      ...
      if (data.hasOwnProperty('sugar')) {
        obj['sugar'] = ApiClient_1.default.convertToType(data['sugar'], [
          Object,
        ])
      }
    }
