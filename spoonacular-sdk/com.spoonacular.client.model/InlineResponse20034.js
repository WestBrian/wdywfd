...
const FoodIngredientsMapProducts_1 = __importDefault(
  require('./FoodIngredientsMapProducts')
)
/**
...
class InlineResponse20034 {
  ...
  constructor(original, originalName, ingredientImage, meta, products) {
    InlineResponse20034.initialize(
      this,
      original,
      originalName,
      ingredientImage,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ingredientImage')) {
        obj['ingredientImage'] = ApiClient_1.default.convertToType(
      ...
      if (data.hasOwnProperty('products')) {
        obj['products'] = ApiClient_1.default.convertToType(data['products'], [
          FoodIngredientsMapProducts_1.default,
        ])
      }
    }
    return obj
