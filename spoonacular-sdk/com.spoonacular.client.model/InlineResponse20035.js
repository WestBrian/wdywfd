...
const InlineResponse20035MenuItems_1 = __importDefault(
  require('./InlineResponse20035MenuItems')
)
/**
...
class InlineResponse20035 {
  ...
  constructor(menuItems, totalMenuItems, type, offset, _number) {
    InlineResponse20035.initialize(
      this,
      menuItems,
      totalMenuItems,
      type,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('menuItems')) {
        obj['menuItems'] = ApiClient_1.default.convertToType(
          data['menuItems'],
          [InlineResponse20035MenuItems_1.default]
        )
      }
      if (data.hasOwnProperty('totalMenuItems')) {
        obj['totalMenuItems'] = ApiClient_1.default.convertToType(
          data['totalMenuItems'],
          'Number'
        )
      }
...
exports.default = InlineResponse20035
