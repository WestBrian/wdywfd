...
const InlineResponse20037Nutrients_1 = __importDefault(
  require('./InlineResponse20037Nutrients')
)
const InlineResponse2005_1 = __importDefault(require('./InlineResponse2005'))
/**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('meals')) {
        obj['meals'] = ApiClient_1.default.convertToType(data['meals'], [
          InlineResponse2005_1.default,
        ])
      }
      if (data.hasOwnProperty('nutrients')) {
        obj['nutrients'] =
          InlineResponse20037Nutrients_1.default.constructFromObject(
            data['nutrients']
          )
      }
    }
