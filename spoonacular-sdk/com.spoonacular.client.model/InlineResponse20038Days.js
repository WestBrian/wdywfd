...
const InlineResponse20038Items_1 = __importDefault(
  require('./InlineResponse20038Items')
)
const InlineResponse20038NutritionSummary_1 = __importDefault(
  require('./InlineResponse20038NutritionSummary')
)
/**
...
class InlineResponse20038Days {
   ...
   */
  static initialize(obj, _date, day) {
    obj['date'] = _date
    obj['day'] = day
  }
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('nutritionSummary')) {
        obj['nutritionSummary'] =
          InlineResponse20038NutritionSummary_1.default.constructFromObject(
            data['nutritionSummary']
          )
      }
      if (data.hasOwnProperty('nutritionSummaryBreakfast')) {
        obj['nutritionSummaryBreakfast'] =
          InlineResponse20038NutritionSummary_1.default.constructFromObject(
            data['nutritionSummaryBreakfast']
          )
      }
      if (data.hasOwnProperty('nutritionSummaryLunch')) {
        obj['nutritionSummaryLunch'] =
          InlineResponse20038NutritionSummary_1.default.constructFromObject(
            data['nutritionSummaryLunch']
          )
      }
      if (data.hasOwnProperty('nutritionSummaryDinner')) {
        obj['nutritionSummaryDinner'] =
          InlineResponse20038NutritionSummary_1.default.constructFromObject(
            data['nutritionSummaryDinner']
          )
      }
      if (data.hasOwnProperty('date')) {
        obj['date'] = ApiClient_1.default.convertToType(data['date'], 'Number')
      }
      if (data.hasOwnProperty('day')) {
        obj['day'] = ApiClient_1.default.convertToType(data['day'], 'String')
      }
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient_1.default.convertToType(data['items'], [
          InlineResponse20038Items_1.default,
        ])
      }
    }
    return obj
