...
class InlineResponse20038NutritionSummaryNutrients {
  ...
  constructor(name, amount, unit, percentDailyNeeds) {
    InlineResponse20038NutritionSummaryNutrients.initialize(
      this,
      name,
      amount,
      unit,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('percentDailyNeeds')) {
        obj['percentDailyNeeds'] = ApiClient_1.default.convertToType(
          data['percentDailyNeeds'],
          'Number'
        )
      }
    }
 ...
 */
InlineResponse20038NutritionSummaryNutrients.prototype['percentDailyNeeds'] =
  undefined
