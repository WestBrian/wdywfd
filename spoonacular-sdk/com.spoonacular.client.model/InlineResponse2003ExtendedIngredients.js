...
const InlineResponse2003Measures_1 = __importDefault(
  require('./InlineResponse2003Measures')
)
/**
...
class InlineResponse2003ExtendedIngredients {
  ...
  constructor(
    ...
    InlineResponse2003ExtendedIngredients.initialize(
      this,
      aisle,
      amount,
      consitency,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('consitency')) {
        obj['consitency'] = ApiClient_1.default.convertToType(
          data['consitency'],
          'String'
        )
      }
      ...
      if (data.hasOwnProperty('measures')) {
        obj['measures'] =
          InlineResponse2003Measures_1.default.constructFromObject(
            data['measures']
          )
      }
