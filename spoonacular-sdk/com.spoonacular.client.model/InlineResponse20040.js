...
const InlineResponse20040Items_1 = __importDefault(
  require('./InlineResponse20040Items')
)
/**
    ...
    if (data) {
      ...
      if (data.hasOwnProperty('items')) {
        obj['items'] = ApiClient_1.default.convertToType(data['items'], [
          InlineResponse20040Items_1.default,
        ])
      }
      if (data.hasOwnProperty('publishAsPublic')) {
        obj['publishAsPublic'] = ApiClient_1.default.convertToType(
          data['publishAsPublic'],
          'Boolean'
        )
      }
    }
...
exports.default = InlineResponse20040
