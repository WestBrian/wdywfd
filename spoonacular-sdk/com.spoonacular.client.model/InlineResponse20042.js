...
const InlineResponse20042Aisles_1 = __importDefault(
  require('./InlineResponse20042Aisles')
)
/**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('aisles')) {
        obj['aisles'] = ApiClient_1.default.convertToType(data['aisles'], [
          InlineResponse20042Aisles_1.default,
        ])
      }
      ...
      if (data.hasOwnProperty('startDate')) {
        obj['startDate'] = ApiClient_1.default.convertToType(
          data['startDate'],
          'Number'
        )
      }
      if (data.hasOwnProperty('endDate')) {
        obj['endDate'] = ApiClient_1.default.convertToType(
          data['endDate'],
          'Number'
        )
      }
