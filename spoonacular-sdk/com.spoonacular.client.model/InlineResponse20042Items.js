...
const InlineResponse20042Measures_1 = __importDefault(
  require('./InlineResponse20042Measures')
)
/**
...
class InlineResponse20042Items {
  ...
  constructor(id, name, pantryItem, aisle, cost, ingredientId) {
    InlineResponse20042Items.initialize(
      this,
      id,
      name,
      pantryItem,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new InlineResponse20042Items()
      ...
      if (data.hasOwnProperty('measures')) {
        obj['measures'] =
          InlineResponse20042Measures_1.default.constructFromObject(
            data['measures']
          )
      }
      if (data.hasOwnProperty('pantryItem')) {
        obj['pantryItem'] = ApiClient_1.default.convertToType(
          data['pantryItem'],
          'Boolean'
        )
      }
      ...
      if (data.hasOwnProperty('cost')) {
        obj['cost'] = ApiClient_1.default.convertToType(data['cost'], 'Number')
      }
      if (data.hasOwnProperty('ingredientId')) {
        obj['ingredientId'] = ApiClient_1.default.convertToType(
          data['ingredientId'],
          'Number'
        )
      }
 ...
 * @member {Number} id
 */
InlineResponse20042Items.prototype['id'] = undefined
/**
 * @member {String} name
 */
InlineResponse20042Items.prototype['name'] = undefined
/**
 * @member {module:com.spoonacular.client/com.spoonacular.client.model/InlineResponse20042Measures} measures
 */
InlineResponse20042Items.prototype['measures'] = undefined
/**
 * @member {Boolean} pantryItem
 */
InlineResponse20042Items.prototype['pantryItem'] = undefined
/**
 * @member {String} aisle
 */
InlineResponse20042Items.prototype['aisle'] = undefined
/**
 * @member {Number} cost
 */
InlineResponse20042Items.prototype['cost'] = undefined
/**
 * @member {Number} ingredientId
 */
InlineResponse20042Items.prototype['ingredientId'] = undefined
exports.default = InlineResponse20042Items
