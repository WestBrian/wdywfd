 ...
 * @module com.spoonacular.client/com.spoonacular.client.model/InlineResponse20043
 * @version 1.0
 */
class InlineResponse20043 {
   ...
   * @param {module:com.spoonacular.client/com.spoonacular.client.model/InlineResponse20043} obj Optional instance to populate.
   * @return {module:com.spoonacular.client/com.spoonacular.client.model/InlineResponse20043} The populated <code>InlineResponse20043</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new InlineResponse20043()
      if (data.hasOwnProperty('username')) {
        obj['username'] = ApiClient_1.default.convertToType(
          data['username'],
          'String'
        )
      }
      if (data.hasOwnProperty('hash')) {
        obj['hash'] = ApiClient_1.default.convertToType(data['hash'], 'String')
      }
    }
    return obj
  }
...
exports.default = InlineResponse20043
