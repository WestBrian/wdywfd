...
const InlineResponse20045ProductMatches_1 = __importDefault(
  require('./InlineResponse20045ProductMatches')
)
/**
...
class InlineResponse20045 {
  ...
  constructor(pairedWines, pairingText, productMatches) {
    InlineResponse20045.initialize(
      this,
      pairedWines,
      pairingText,
      productMatches
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('pairedWines')) {
        obj['pairedWines'] = ApiClient_1.default.convertToType(
          data['pairedWines'],
          ['String']
        )
      }
      if (data.hasOwnProperty('pairingText')) {
        obj['pairingText'] = ApiClient_1.default.convertToType(
          data['pairingText'],
          'String'
        )
      }
      if (data.hasOwnProperty('productMatches')) {
        obj['productMatches'] = ApiClient_1.default.convertToType(
          data['productMatches'],
...
exports.default = InlineResponse20045
