...
const InlineResponse20049NutritionCaloriesConfidenceRange95Percent_1 =
  __importDefault(
    require('./InlineResponse20049NutritionCaloriesConfidenceRange95Percent')
  )
/**
...
class InlineResponse20049NutritionCalories {
  ...
  constructor(value, unit, confidenceRange95Percent, standardDeviation) {
    InlineResponse20049NutritionCalories.initialize(
      this,
      value,
      unit,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('value')) {
        obj['value'] = ApiClient_1.default.convertToType(
          data['value'],
          'Number'
        )
      }
      ...
      if (data.hasOwnProperty('confidenceRange95Percent')) {
        obj['confidenceRange95Percent'] =
          InlineResponse20049NutritionCaloriesConfidenceRange95Percent_1.default.constructFromObject(
            data['confidenceRange95Percent']
          )
      }
      if (data.hasOwnProperty('standardDeviation')) {
        obj['standardDeviation'] = ApiClient_1.default.convertToType(
 ...
 */
InlineResponse20049NutritionCalories.prototype['confidenceRange95Percent'] =
  undefined
/**
