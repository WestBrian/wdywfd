...
class InlineResponse20052 {
  ...
  constructor(articles, groceryProducts, menuItems, recipes) {
    InlineResponse20052.initialize(
      this,
      articles,
      groceryProducts,
      menuItems,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Articles')) {
        obj['Articles'] = ApiClient_1.default.convertToType(data['Articles'], [
          Object,
        ])
      }
      if (data.hasOwnProperty('Grocery Products')) {
        obj['Grocery Products'] = ApiClient_1.default.convertToType(
          data['Grocery Products'],
          [Object]
        )
      }
      if (data.hasOwnProperty('Menu Items')) {
        obj['Menu Items'] = ApiClient_1.default.convertToType(
          data['Menu Items'],
          [Object]
        )
      }
...
exports.default = InlineResponse20052
