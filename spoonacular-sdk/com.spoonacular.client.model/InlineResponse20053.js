...
const InlineResponse20053SearchResults_1 = __importDefault(
  require('./InlineResponse20053SearchResults')
)
/**
...
class InlineResponse20053 {
  ...
  constructor(query, totalResults, limit, offset, searchResults) {
    InlineResponse20053.initialize(
      this,
      query,
      totalResults,
      limit,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('query')) {
        obj['query'] = ApiClient_1.default.convertToType(
          data['query'],
          'String'
        )
      }
      ...
      if (data.hasOwnProperty('limit')) {
        obj['limit'] = ApiClient_1.default.convertToType(
          data['limit'],
          'Number'
        )
      }
      ...
      if (data.hasOwnProperty('searchResults')) {
        obj['searchResults'] = ApiClient_1.default.convertToType(
          data['searchResults'],
