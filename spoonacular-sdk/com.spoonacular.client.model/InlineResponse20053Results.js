...
class InlineResponse20053Results {
  ...
  constructor(id, name, image, link, type, relevance, content) {
    InlineResponse20053Results.initialize(
      this,
      id,
      name,
      image,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('id')) {
        obj['id'] = ApiClient_1.default.convertToType(data['id'], 'String')
      }
      ...
      if (data.hasOwnProperty('relevance')) {
        obj['relevance'] = ApiClient_1.default.convertToType(
          data['relevance'],
          'Number'
        )
      }
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient_1.default.convertToType(
          data['content'],
          'String'
        )
      }
...
exports.default = InlineResponse20053Results
