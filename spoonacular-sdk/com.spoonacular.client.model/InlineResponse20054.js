...
const InlineResponse20054Videos_1 = __importDefault(
  require('./InlineResponse20054Videos')
)
/**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('videos')) {
        obj['videos'] = ApiClient_1.default.convertToType(data['videos'], [
          InlineResponse20054Videos_1.default,
        ])
      }
...
exports.default = InlineResponse20054
