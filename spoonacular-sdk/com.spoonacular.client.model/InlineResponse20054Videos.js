...
class InlineResponse20054Videos {
  ...
  constructor(title, length, rating, shortTitle, thumbnail, views, youTubeId) {
    InlineResponse20054Videos.initialize(
      this,
      title,
      length,
      rating,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('length')) {
        obj['length'] = ApiClient_1.default.convertToType(
          data['length'],
          'Number'
        )
      }
      if (data.hasOwnProperty('rating')) {
        obj['rating'] = ApiClient_1.default.convertToType(
          data['rating'],
          'Number'
        )
      }
      if (data.hasOwnProperty('shortTitle')) {
        obj['shortTitle'] = ApiClient_1.default.convertToType(
          data['shortTitle'],
          'String'
        )
      }
      if (data.hasOwnProperty('thumbnail')) {
        obj['thumbnail'] = ApiClient_1.default.convertToType(
          data['thumbnail'],
          'String'
        )
      }
      if (data.hasOwnProperty('views')) {
        obj['views'] = ApiClient_1.default.convertToType(
          data['views'],
          'Number'
        )
      }
      if (data.hasOwnProperty('youTubeId')) {
        obj['youTubeId'] = ApiClient_1.default.convertToType(
          data['youTubeId'],
          'String'
        )
      }
...
exports.default = InlineResponse20054Videos
