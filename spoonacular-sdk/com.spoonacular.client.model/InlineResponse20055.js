 ...
 * @module com.spoonacular.client/com.spoonacular.client.model/InlineResponse20055
 * @version 1.0
 */
class InlineResponse20055 {
   ...
   * @param {module:com.spoonacular.client/com.spoonacular.client.model/InlineResponse20055} obj Optional instance to populate.
   * @return {module:com.spoonacular.client/com.spoonacular.client.model/InlineResponse20055} The populated <code>InlineResponse20055</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new InlineResponse20055()
      if (data.hasOwnProperty('text')) {
        obj['text'] = ApiClient_1.default.convertToType(data['text'], 'String')
      }
    }
    return obj
  }
...
exports.default = InlineResponse20055
