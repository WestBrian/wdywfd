...
const InlineResponse2003ExtendedIngredients_1 = __importDefault(
  require('./InlineResponse2003ExtendedIngredients')
)
const InlineResponse2003WinePairing_1 = __importDefault(
  require('./InlineResponse2003WinePairing')
)
/**
...
class InlineResponse2006Recipes {
  ...
  constructor(
    ...
    InlineResponse2006Recipes.initialize(
      this,
      id,
      title,
      image,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('servings')) {
        obj['servings'] = ApiClient_1.default.convertToType(
          data['servings'],
          'Number'
        )
      }
      if (data.hasOwnProperty('readyInMinutes')) {
        obj['readyInMinutes'] = ApiClient_1.default.convertToType(
          data['readyInMinutes'],
          'Number'
        )
      }
      if (data.hasOwnProperty('license')) {
        obj['license'] = ApiClient_1.default.convertToType(
          data['license'],
          'String'
        )
      }
      if (data.hasOwnProperty('sourceName')) {
        obj['sourceName'] = ApiClient_1.default.convertToType(
          data['sourceName'],
          'String'
        )
      }
      if (data.hasOwnProperty('sourceUrl')) {
        obj['sourceUrl'] = ApiClient_1.default.convertToType(
          data['sourceUrl'],
          'String'
        )
      }
      if (data.hasOwnProperty('spoonacularSourceUrl')) {
        obj['spoonacularSourceUrl'] = ApiClient_1.default.convertToType(
          data['spoonacularSourceUrl'],
          'String'
        )
      }
      if (data.hasOwnProperty('aggregateLikes')) {
        obj['aggregateLikes'] = ApiClient_1.default.convertToType(
          data['aggregateLikes'],
          'Number'
        )
      }
      if (data.hasOwnProperty('healthScore')) {
        obj['healthScore'] = ApiClient_1.default.convertToType(
          data['healthScore'],
          'Number'
        )
      }
      ...
      if (data.hasOwnProperty('pricePerServing')) {
        obj['pricePerServing'] = ApiClient_1.default.convertToType(
          data['pricePerServing'],
          'Number'
        )
      }
      if (data.hasOwnProperty('analyzedInstructions')) {
        obj['analyzedInstructions'] = ApiClient_1.default.convertToType(
          data['analyzedInstructions'],
          [Object]
        )
      }
      if (data.hasOwnProperty('cheap')) {
        obj['cheap'] = ApiClient_1.default.convertToType(
          data['cheap'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('creditsText')) {
        obj['creditsText'] = ApiClient_1.default.convertToType(
          data['creditsText'],
          'String'
        )
      }
      if (data.hasOwnProperty('cuisines')) {
        obj['cuisines'] = ApiClient_1.default.convertToType(data['cuisines'], [
          'String',
        ])
      }
      if (data.hasOwnProperty('dairyFree')) {
        obj['dairyFree'] = ApiClient_1.default.convertToType(
          data['dairyFree'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('diets')) {
        obj['diets'] = ApiClient_1.default.convertToType(data['diets'], [
          'String',
        ])
      }
      if (data.hasOwnProperty('gaps')) {
        obj['gaps'] = ApiClient_1.default.convertToType(data['gaps'], 'String')
      }
      if (data.hasOwnProperty('glutenFree')) {
        obj['glutenFree'] = ApiClient_1.default.convertToType(
          data['glutenFree'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('instructions')) {
        obj['instructions'] = ApiClient_1.default.convertToType(
          data['instructions'],
          'String'
        )
      }
      if (data.hasOwnProperty('ketogenic')) {
        obj['ketogenic'] = ApiClient_1.default.convertToType(
          data['ketogenic'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('lowFodmap')) {
        obj['lowFodmap'] = ApiClient_1.default.convertToType(
          data['lowFodmap'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('occasions')) {
        obj['occasions'] = ApiClient_1.default.convertToType(
          data['occasions'],
          ['String']
        )
      }
      if (data.hasOwnProperty('sustainable')) {
        obj['sustainable'] = ApiClient_1.default.convertToType(
          data['sustainable'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('vegan')) {
        obj['vegan'] = ApiClient_1.default.convertToType(
          data['vegan'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('vegetarian')) {
        obj['vegetarian'] = ApiClient_1.default.convertToType(
          data['vegetarian'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('veryHealthy')) {
        obj['veryHealthy'] = ApiClient_1.default.convertToType(
          data['veryHealthy'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('veryPopular')) {
        obj['veryPopular'] = ApiClient_1.default.convertToType(
          data['veryPopular'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('whole30')) {
        obj['whole30'] = ApiClient_1.default.convertToType(
          data['whole30'],
          'Boolean'
        )
      }
      if (data.hasOwnProperty('weightWatcherSmartPoints')) {
        obj['weightWatcherSmartPoints'] = ApiClient_1.default.convertToType(
          data['weightWatcherSmartPoints'],
          'Number'
        )
      }
      if (data.hasOwnProperty('dishTypes')) {
        obj['dishTypes'] = ApiClient_1.default.convertToType(
          data['dishTypes'],
          ['String']
        )
      }
      if (data.hasOwnProperty('extendedIngredients')) {
        obj['extendedIngredients'] = ApiClient_1.default.convertToType(
          data['extendedIngredients'],
          [InlineResponse2003ExtendedIngredients_1.default]
        )
      }
      if (data.hasOwnProperty('summary')) {
        obj['summary'] = ApiClient_1.default.convertToType(
          data['summary'],
          'String'
        )
      }
      if (data.hasOwnProperty('winePairing')) {
        obj['winePairing'] =
          InlineResponse2003WinePairing_1.default.constructFromObject(
            data['winePairing']
          )
      }
    }
