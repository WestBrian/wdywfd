  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('sweetness')) {
        obj['sweetness'] = ApiClient_1.default.convertToType(
          data['sweetness'],
          'Number'
        )
      }
      if (data.hasOwnProperty('saltiness')) {
        obj['saltiness'] = ApiClient_1.default.convertToType(
          data['saltiness'],
          'Number'
        )
      }
      if (data.hasOwnProperty('sourness')) {
        obj['sourness'] = ApiClient_1.default.convertToType(
          data['sourness'],
          'Number'
        )
      }
      if (data.hasOwnProperty('bitterness')) {
        obj['bitterness'] = ApiClient_1.default.convertToType(
          data['bitterness'],
          'Number'
        )
      }
      if (data.hasOwnProperty('savoriness')) {
        obj['savoriness'] = ApiClient_1.default.convertToType(
          data['savoriness'],
          'Number'
        )
      }
      if (data.hasOwnProperty('fattiness')) {
        obj['fattiness'] = ApiClient_1.default.convertToType(
          data['fattiness'],
          'Number'
        )
      }
      if (data.hasOwnProperty('spiciness')) {
        obj['spiciness'] = ApiClient_1.default.convertToType(
          data['spiciness'],
          'Number'
        )
      }
