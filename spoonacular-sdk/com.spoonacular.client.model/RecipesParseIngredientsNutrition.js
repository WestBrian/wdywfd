...
const RecipesParseIngredientsNutritionCaloricBreakdown_1 = __importDefault(
  require('./RecipesParseIngredientsNutritionCaloricBreakdown')
)
const RecipesParseIngredientsNutritionNutrients_1 = __importDefault(
  require('./RecipesParseIngredientsNutritionNutrients')
)
const RecipesParseIngredientsNutritionProperties_1 = __importDefault(
  require('./RecipesParseIngredientsNutritionProperties')
)
const RecipesParseIngredientsNutritionWeightPerServing_1 = __importDefault(
  require('./RecipesParseIngredientsNutritionWeightPerServing')
)
/**
...
class RecipesParseIngredientsNutrition {
  ...
  constructor(
    ...
    RecipesParseIngredientsNutrition.initialize(
      this,
      nutrients,
      properties,
      flavonoids,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('properties')) {
        obj['properties'] = ApiClient_1.default.convertToType(
          data['properties'],
          [RecipesParseIngredientsNutritionProperties_1.default]
        )
      }
      if (data.hasOwnProperty('flavonoids')) {
        obj['flavonoids'] = ApiClient_1.default.convertToType(
          data['flavonoids'],
          [RecipesParseIngredientsNutritionProperties_1.default]
        )
      }
      if (data.hasOwnProperty('caloricBreakdown')) {
        obj['caloricBreakdown'] =
          RecipesParseIngredientsNutritionCaloricBreakdown_1.default.constructFromObject(
            data['caloricBreakdown']
          )
      }
      if (data.hasOwnProperty('weightPerServing')) {
        obj['weightPerServing'] =
          RecipesParseIngredientsNutritionWeightPerServing_1.default.constructFromObject(
            data['weightPerServing']
          )
      }
    }
    return obj
