...
class RecipesParseIngredientsNutritionNutrients {
  ...
  constructor(name, amount, unit, percentOfDailyNeeds) {
    RecipesParseIngredientsNutritionNutrients.initialize(
      this,
      name,
      amount,
      unit,
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('percentOfDailyNeeds')) {
        obj['percentOfDailyNeeds'] = ApiClient_1.default.convertToType(
          data['percentOfDailyNeeds'],
          'Number'
        )
      }
    }
 ...
 */
RecipesParseIngredientsNutritionNutrients.prototype['percentOfDailyNeeds'] =
  undefined
