...
class RecipesParseIngredientsNutritionProperties {
  ...
  constructor(name, amount, unit) {
    RecipesParseIngredientsNutritionProperties.initialize(
      this,
      name,
      amount,
      unit
  ...
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new RecipesParseIngredientsNutritionProperties()
 ...
 * @member {String} name
 */
RecipesParseIngredientsNutritionProperties.prototype['name'] = undefined
/**
 * @member {Number} amount
 */
RecipesParseIngredientsNutritionProperties.prototype['amount'] = undefined
/**
 * @member {String} unit
 */
RecipesParseIngredientsNutritionProperties.prototype['unit'] = undefined
exports.default = RecipesParseIngredientsNutritionProperties
