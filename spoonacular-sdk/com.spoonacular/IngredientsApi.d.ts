...
export default class IngredientsApi {
   ...
   */
  getIngredientSubstitutes(ingredientName: string, callback: any): any
  /**
   ...
   * data is of type: {@link module:com.spoonacular.client/com.spoonacular.client.model/InlineResponse20026}
   */
  getIngredientSubstitutesByID(id: number, callback: any): any
  /**
   ...
   */
  mapIngredientsToGroceryProducts(inlineObject2: any, callback: any): any
  /**
...
//# sourceMappingURL=IngredientsApi.d.ts.map
