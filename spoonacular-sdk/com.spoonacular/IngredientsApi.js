...
class IngredientsApi {
  ...
  autocompleteIngredientSearch(opts, callback) {
    ...
    let returnType = [InlineResponse20024_1.default]
  ...
  computeIngredientAmount(id, nutrient, target, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = RecipesParseIngredientsNutritionWeightPerServing_1.default
    return this.apiClient.callApi(
  ...
  getIngredientInformation(id, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20022_1.default
    return this.apiClient.callApi(
  ...
  getIngredientSubstitutes(ingredientName, callback) {
    ...
    if (ingredientName === undefined || ingredientName === null) {
      throw new Error(
        "Missing the required parameter 'ingredientName' when calling getIngredientSubstitutes"
      )
    }
    let pathParams = {}
    let queryParams = {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20026_1.default
    return this.apiClient.callApi(
  ...
  ingredientSearch(opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20025_1.default
    return this.apiClient.callApi(
   ...
   */
  mapIngredientsToGroceryProducts(inlineObject2, callback) {
    ...
    if (inlineObject2 === undefined || inlineObject2 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject2' when calling mapIngredientsToGroceryProducts"
      )
    }
    let pathParams = {}
    let queryParams = {}
    ...
    let accepts = ['application/json']
    let returnType = [InlineResponse20034_1.default]
    return this.apiClient.callApi(
