...
class MealPlanningApi {
  ...
  addMealPlanTemplate(username, hash, inlineObject6, callback) {
    ...
    if (inlineObject6 === undefined || inlineObject6 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject6' when calling addMealPlanTemplate"
      )
    }
    let pathParams = {
      username: username,
    ...
    let returnType = InlineResponse20040_1.default
  ...
  addToMealPlan(username, hash, inlineObject4, callback) {
    ...
    if (inlineObject4 === undefined || inlineObject4 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject4' when calling addToMealPlan"
      )
    }
    let pathParams = {
      username: username,
  ...
  addToShoppingList(username, hash, inlineObject9, callback) {
    ...
    if (inlineObject9 === undefined || inlineObject9 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject9' when calling addToShoppingList"
      )
    }
    let pathParams = {
      username: username,
    ...
    let contentTypes = ['', 'application/json']
    let accepts = ['application/json']
    let returnType = InlineResponse20042_1.default
    return this.apiClient.callApi(
  ...
  clearMealPlanDay(username, _date, hash, inlineObject3, callback) {
    ...
    if (_date === undefined || _date === null) {
      throw new Error(
        "Missing the required parameter '_date' when calling clearMealPlanDay"
      )
    }
    // verify the required parameter 'hash' is set
    if (hash === undefined || hash === null) {
    ...
    if (inlineObject3 === undefined || inlineObject3 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject3' when calling clearMealPlanDay"
      )
    }
    let pathParams = {
      username: username,
  ...
  connectUser(body, callback) {
    ...
    let contentTypes = ['', 'application/json']
    let accepts = ['application/json']
    let returnType = InlineResponse20043_1.default
    return this.apiClient.callApi(
      '/users/connect',
      'POST',
      pathParams,
  ...
  deleteFromMealPlan(username, id, hash, inlineObject5, callback) {
    ...
    if (inlineObject5 === undefined || inlineObject5 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject5' when calling deleteFromMealPlan"
      )
    }
    let pathParams = {
      username: username,
  ...
  deleteFromShoppingList(username, id, hash, inlineObject10, callback) {
    ...
    if (inlineObject10 === undefined || inlineObject10 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject10' when calling deleteFromShoppingList"
      )
    }
    let pathParams = {
      username: username,
  ...
  deleteMealPlanTemplate(username, id, hash, inlineObject7, callback) {
    ...
    if (inlineObject7 === undefined || inlineObject7 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject7' when calling deleteMealPlanTemplate"
      )
    }
    let pathParams = {
      username: username,
  ...
  generateMealPlan(opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20037_1.default
    return this.apiClient.callApi(
  ...
  generateShoppingList(
    ...
    if (startDate === undefined || startDate === null) {
      throw new Error(
        "Missing the required parameter 'startDate' when calling generateShoppingList"
      )
    }
    // verify the required parameter 'endDate' is set
    if (endDate === undefined || endDate === null) {
      throw new Error(
        "Missing the required parameter 'endDate' when calling generateShoppingList"
      )
    }
    // verify the required parameter 'hash' is set
    if (hash === undefined || hash === null) {
    ...
    if (inlineObject8 === undefined || inlineObject8 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject8' when calling generateShoppingList"
      )
    }
    let pathParams = {
      username: username,
  ...
  getMealPlanTemplate(username, id, hash, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20041_1.default
    return this.apiClient.callApi(
      '/mealplanner/{username}/templates/{id}',
      'GET',
      pathParams,
  ...
  getMealPlanTemplates(username, hash, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20039_1.default
    return this.apiClient.callApi(
      '/mealplanner/{username}/templates',
      'GET',
      pathParams,
  ...
  getMealPlanWeek(username, startDate, hash, callback) {
    ...
    if (startDate === undefined || startDate === null) {
      throw new Error(
        "Missing the required parameter 'startDate' when calling getMealPlanWeek"
      )
    }
    // verify the required parameter 'hash' is set
    if (hash === undefined || hash === null) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20038_1.default
    return this.apiClient.callApi(
