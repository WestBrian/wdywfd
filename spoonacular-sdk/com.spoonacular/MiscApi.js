...
class MiscApi {
  ...
  detectFoodInText(opts, callback) {
    ...
    let returnType = InlineResponse20051_1.default
  ...
  getARandomFoodJoke(callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20055_1.default
    return this.apiClient.callApi(
      '/food/jokes/random',
      'GET',
      pathParams,
  ...
  getConversationSuggests(query, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20057_1.default
    return this.apiClient.callApi(
  ...
  imageAnalysisByURL(imageUrl, callback) {
    ...
    if (imageUrl === undefined || imageUrl === null) {
      throw new Error(
        "Missing the required parameter 'imageUrl' when calling imageAnalysisByURL"
      )
    }
    let pathParams = {}
    let queryParams = {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20049_1.default
    return this.apiClient.callApi(
      '/food/images/analyze',
      'GET',
      pathParams,
  ...
  imageClassificationByURL(imageUrl, callback) {
    ...
    if (imageUrl === undefined || imageUrl === null) {
      throw new Error(
        "Missing the required parameter 'imageUrl' when calling imageClassificationByURL"
      )
    }
    let pathParams = {}
    let queryParams = {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20048_1.default
    return this.apiClient.callApi(
  ...
  searchAllFood(query, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20053_1.default
    return this.apiClient.callApi(
      '/food/search',
      'GET',
      pathParams,
  ...
  searchCustomFoods(username, hash, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20029_1.default
    return this.apiClient.callApi(
  ...
  searchFoodVideos(opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20054_1.default
    return this.apiClient.callApi(
      '/food/videos/search',
      'GET',
      pathParams,
  ...
  searchSiteContent(query, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20052_1.default
    return this.apiClient.callApi(
      '/food/site/search',
      'GET',
      pathParams,
  ...
  talkToChatbot(text, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20056_1.default
    return this.apiClient.callApi(
      '/food/converse',
      'GET',
      pathParams,
