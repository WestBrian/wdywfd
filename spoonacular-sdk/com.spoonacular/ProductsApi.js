...
class ProductsApi {
  ...
  autocompleteProductSearch(query, opts, callback) {
    ...
    let returnType = InlineResponse20032_1.default
   ...
   */
  classifyGroceryProduct(inlineObject1, opts, callback) {
    opts = opts || {}
    let postBody = inlineObject1
    // verify the required parameter 'inlineObject1' is set
    if (inlineObject1 === undefined || inlineObject1 === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject1' when calling classifyGroceryProduct"
      )
    }
    let pathParams = {}
    let queryParams = {
    ...
    let accepts = ['application/json']
    let returnType = InlineResponse20033_1.default
    return this.apiClient.callApi(
   ...
   */
  classifyGroceryProductBulk(inlineObject, opts, callback) {
    opts = opts || {}
    let postBody = inlineObject
    // verify the required parameter 'inlineObject' is set
    if (inlineObject === undefined || inlineObject === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject' when calling classifyGroceryProductBulk"
      )
    }
    let pathParams = {}
    let queryParams = {
  ...
  getComparableProducts(upc, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20031_1.default
    return this.apiClient.callApi(
  ...
  getProductInformation(id, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20030_1.default
    return this.apiClient.callApi(
      '/food/products/{id}',
      'GET',
      pathParams,
  ...
  searchGroceryProducts(opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20027_1.default
    return this.apiClient.callApi(
  ...
  searchGroceryProductsByUPC(upc, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20028_1.default
    return this.apiClient.callApi(
