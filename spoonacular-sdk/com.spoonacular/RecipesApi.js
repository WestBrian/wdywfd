...
class RecipesApi {
  ...
  constructor(apiClient) {
    this.apiClient = apiClient || ApiClient_1.default.instance
  }
  /**
  ...
  analyzeARecipeSearchQuery(q, callback) {
    ...
    let returnType = InlineResponse20018_1.default
  ...
  analyzeRecipeInstructions(opts, callback) {
    ...
    let accepts = ['application/json']
    let returnType = InlineResponse20016_1.default
    return this.apiClient.callApi(
  ...
  autocompleteRecipeSearch(opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = [InlineResponse2007_1.default]
    return this.apiClient.callApi(
  ...
  classifyCuisine(opts, callback) {
    ...
    let contentTypes = ['application/x-www-form-urlencoded']
    let accepts = ['application/json']
    let returnType = InlineResponse20017_1.default
    return this.apiClient.callApi(
      '/recipes/cuisine',
      'POST',
      pathParams,
   ...
   */
  computeGlycemicLoad(inlineObject, opts, callback) {
    opts = opts || {}
    let postBody = inlineObject
    // verify the required parameter 'inlineObject' is set
    if (inlineObject === undefined || inlineObject === null) {
      throw new Error(
        "Missing the required parameter 'inlineObject' when calling computeGlycemicLoad"
      )
    }
    let pathParams = {}
    let queryParams = {
    ...
    let accepts = ['application/json']
    let returnType = InlineResponse20023_1.default
    return this.apiClient.callApi(
  ...
  convertAmounts(
    ...
    if (ingredientName === undefined || ingredientName === null) {
      throw new Error(
        "Missing the required parameter 'ingredientName' when calling convertAmounts"
      )
    }
    // verify the required parameter 'sourceAmount' is set
    if (sourceAmount === undefined || sourceAmount === null) {
      throw new Error(
        "Missing the required parameter 'sourceAmount' when calling convertAmounts"
      )
    }
    // verify the required parameter 'sourceUnit' is set
    if (sourceUnit === undefined || sourceUnit === null) {
      throw new Error(
        "Missing the required parameter 'sourceUnit' when calling convertAmounts"
      )
    }
    // verify the required parameter 'targetUnit' is set
    if (targetUnit === undefined || targetUnit === null) {
      throw new Error(
        "Missing the required parameter 'targetUnit' when calling convertAmounts"
      )
    }
    let pathParams = {}
    let queryParams = {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20019_1.default
    return this.apiClient.callApi(
      '/recipes/convert',
      'GET',
      pathParams,
  ...
  createRecipeCard(opts, callback) {
    ...
    let accepts = ['application/json']
    let returnType = InlineResponse20015_1.default
    return this.apiClient.callApi(
  ...
  extractRecipeFromWebsite(url, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse2003_1.default
    return this.apiClient.callApi(
      '/recipes/extract',
      'GET',
      pathParams,
  ...
  getAnalyzedRecipeInstructions(id, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20013_1.default
    return this.apiClient.callApi(
  ...
  getRandomRecipes(opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse2006_1.default
    return this.apiClient.callApi(
      '/recipes/random',
      'GET',
      pathParams,
  ...
  getRecipeEquipmentByID(id, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse2009_1.default
    return this.apiClient.callApi(
  ...
  getRecipeInformationBulk(ids, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = [InlineResponse2004_1.default]
    return this.apiClient.callApi(
  ...
  getRecipeIngredientsByID(id, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20011_1.default
    return this.apiClient.callApi(
  ...
  getRecipeNutritionWidgetByID(id, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20012_1.default
    return this.apiClient.callApi(
  ...
  getRecipePriceBreakdownByID(id, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20010_1.default
    return this.apiClient.callApi(
  ...
  getRecipeTasteByID(id, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse2008_1.default
    return this.apiClient.callApi(
  ...
  getSimilarRecipes(id, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = [InlineResponse2005_1.default]
    return this.apiClient.callApi(
      '/recipes/{id}/similar',
      'GET',
      pathParams,
  ...
  guessNutritionByDishName(title, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20021_1.default
    return this.apiClient.callApi(
  ...
  parseIngredients(opts, callback) {
    ...
    let contentTypes = ['application/x-www-form-urlencoded']
    let accepts = ['application/json']
    let returnType = [InlineResponse20020_1.default]
    return this.apiClient.callApi(
  ...
  quickAnswer(q, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20050_1.default
    return this.apiClient.callApi(
      '/recipes/quickAnswer',
      'GET',
      pathParams,
  ...
  searchRecipes(opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse200_1.default
    return this.apiClient.callApi(
  ...
  searchRecipesByIngredients(opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = [InlineResponse2001_1.default]
    return this.apiClient.callApi(
  ...
  searchRecipesByNutrients(opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = [InlineResponse2002_1.default]
    return this.apiClient.callApi(
  ...
  summarizeRecipe(id, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20014_1.default
    return this.apiClient.callApi(
      '/recipes/{id}/summary',
      'GET',
      pathParams,
