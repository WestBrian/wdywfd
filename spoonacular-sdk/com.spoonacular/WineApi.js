...
class WineApi {
  ...
  getDishPairingForWine(wine, callback) {
    ...
    let returnType = InlineResponse20044_1.default
  ...
  getWineDescription(wine, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20046_1.default
    return this.apiClient.callApi(
  ...
  getWinePairing(food, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20045_1.default
    return this.apiClient.callApi(
      '/food/wine/pairing',
      'GET',
      pathParams,
  ...
  getWineRecommendation(wine, opts, callback) {
    ...
    let contentTypes = []
    let accepts = ['application/json']
    let returnType = InlineResponse20047_1.default
    return this.apiClient.callApi(
